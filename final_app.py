...
class LoginPage(Frame):
    def __init__(self, master, controller):
        ...
        self.button = Button(self, height=2, width=10, text="Login", command=self.verify_login)
...
class CourseWindow(Frame):
    def __init__(self, master, controller):
        ...
        self.button = Button(self, text="Back", command = lambda : 
                             controller.show_frame(MainWindow))
        self.button.place(x=20, y=555)       
...
class CalcWindow(Frame):
    ...
    def calculate(self):
        ...
        result = (((float(self.e1.get())*self.d1_gpa)
...
class GraphWindow(Frame):
    def __init__(self, master, controller):
        ...
        self.button = Button(self, height=2, text="Enter Program Name", command=self.get_name)
        self.button.place(x=290, y=60)
        # Creates button that clears the graph in order to create a new one
        self.button1 = Button(self, height=2, text="Reset", command=self._clear)
        self.button1.place(x=450, y=60)
        # Creates label indicating input status
        self.label = Label(self, text="Enter the exact name of the program.\nFor example: Biology MSc, Biology "
                                             "PhD")
    ...
    def get_name(self,):
        ...
        if dg.check_program(s) is False:
            ...
            self.label.config(text="Enter the exact name of the program.\nFor example: Biology MSc, Biology PhD")
...
class StudentWindow(Frame):
    def __init__(self, master, controller):
        ...
        self.label2.place(x=145, y=400)        
        # Creates entry box for user input
        self.entry = Entry(self, width=30)
        self.entry.place(x=400, y=250)
        # Creates button to trigger the record update
        self.button = Button(self, height=2, text="Update Records", command=self.get_data)
        self.button.place(x=400, y=280)
        
        self.button2 = Button(self, text="Back", command = lambda : 
                             controller.show_frame(MainWindow))
